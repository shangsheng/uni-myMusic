...
/***/ 157:
/*!*********************************************************************!*\
  !*** E:/bodhi/uni-app/uni-myMusic/components/uni-forms/validate.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;var _index = _interopRequireDefault(__webpack_require__(/*! @/js_sdk/luch-request/luch-request/index.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
}, function (response) {// 请求错误。可以使用async await 做异步操作  
...
/***/ 172:
/*!***********************************************************************!*\
  !*** E:/bodhi/uni-app/uni-myMusic/components/uni-easyinput/common.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
//登录
//手机登陆
var phoneLogin = '/login/cellphone';
//邮箱登陆
var emailLogin = '/login';
//刷新登录
var refreshLogin = '/login/refresh';
//发送验证码
var captchaSent = '/captcha/sent';
//验证验证码
var captchaVerify = '/captcha/verify';
//注册(修改密码)
var registerCellphone = '/register/cellphone';
//检测手机号码是否已注册
var cellphoneCheck = '/cellphone/existence/check';
//初始化昵称
var activateProfile = '/activate/init/profile';
//更换绑定手机
var rebind = '/rebind';
//获取动态消息
var _event = '/event';
//歌手分类列表
var _artistList = '/artist/list';
//收藏歌手
var _artistSub = '/artist/sub';
//取消收藏歌手
var _artistUnsub = '/artist/unsub';
//收藏的歌手列表
var _artistSublist = '/artist/sublist';
//歌单分类
var _playlistCatlist = '/playlist/catlist';
//热门歌单分类
var _playlistHot = '/playlist/hot';
//歌单(网友精选碟)
var _topPlaylsit = '/top/playlist';
//获取精品歌单
var _topPlaylistHighquality = '/top/playlist/highquality';
// 获取歌单详情
var _playlistDetail = '/playlist/detail';
// 获取音乐 url
var _musicUrl = '/song/url';
//音乐是否可用
var _checkMusic = '/check/music';
// 搜索
var _secrch = '/search';
//热搜
var _secrchHot = '/search/hot';
//搜索建议
var _searchSuggest = '/search/suggest';
//搜索多重匹配
var _searchMultimatch = '/search/multimatch';
//新建歌单
var _playlistCreate = '/playlist/create';
//收藏 / 取消收藏歌单
var _playlistSubscribe = '/playlist/subscribe';
//获取歌词
var _lyric = '/lyric';
//歌曲评论
var _commentMusic = '/comment/music';
//专辑评论
var _commentAlbum = '/comment/album';
//歌单评论
var _commentPlaylist = '/comment/playlist';
//mv 评论
var _commentMv = '/comment/mv';
//电台节目评论
var _commentDj = '/comment/dj';
// 获取歌曲详情
var _songDetail = '/song/detail';
// 获取专辑内容
var _album = '/album';
// 获取歌手单曲
var _artists = '/artists';
//获取歌手 mv
var _artistsMv = '/artist/mv';
// 获取歌手专辑
var _artistAlbum = '/artist/album';
//获取歌手描述
var _artistDesc = '/artist/desc';
//获取相似歌手
var _simiArtist = '/simi/artist';
//获取相似歌单
var _simiPlaylist = '/simi/playlist';
//相似 mv
var _simiMv = '/simi/mv';
//获取相似音乐
var _simiSong = '/simi/song';
//获取最近 5 个听了这首歌的用户
var _simiUser = '/simi/user';
// 喜欢音乐
var _like = '/like';
//垃圾桶
var _fmTrash = '/fm_trash';
//新碟上架
var _topAlbum = '/top/album';
// 热门歌手
var _topArtists = '/top/artists';
//最新 mv
var _mvFirst = '/mv/first';
//推荐 mv
var _personalizedMv = '/personalized/mv';
// 推荐歌单
var _personalized = '/personalized';
//推荐新音乐
var _personalizedNewsong = '/personalized/newsong';
//推荐电台
var _presonalizedDjprogram = '/personalized/djprogram';
//推荐节目
var _programRecommend = '/program/recommend';
// 独家放送(入口列表)
var _personalizedPrivatecontent = '/personalized/privatecontent';
// mv 排行
var _topMv = '/top/mv';
// 获取 mv 数据
var _mv = '/mv';
...
//所有榜单内容摘要
var _toplistDetail = '/toplist/detail';
// 歌手榜
var _toplistArtist = '/toplist/artist';
//获取用户详情
var _userDetail = '/user/detail';
//获取用户信息, 歌单，收藏，mv, dj 数量
var _userSubcount = '/user/subcount';
//获取用户歌单
var _userPlaylist = '/user/playlist';
//更新歌单
var _playlistUpdate = '/playlist/update';
//发送私信
var _sendText = '/send/text';
//发送私信(带歌单)
var _sendPlaylist = '/send/playlist';
//获取用户电台
var _userDj = '/user/dj';
//获取用户关注列表
var _userFollows = '/user/follows';
//获取用户粉丝列表
var _userfolloweds = '/user/followeds';
//获取用户动态
var _userEvent = '/user/event';
//获取用户播放记录
var _userRecord = '/user/record';
// 对歌单添加或删除歌曲
var _playlistTracks = '/playlist/tracks';
// 给评论点赞
var _commentLike = '/comment/like';
//获取每日推荐歌单
var _recommendResource = '/recommend/resource';
// 获取每日推荐歌曲
var _recommendSongs = '/recommend/songs';
// 私人 FM
var _personalFm = '/personal_fm';
// 签到
var _dailySignin = '/daily_signin';
// 云盘
var _userCloud = '/user/cloud';
//电台 - 推荐
var _djRecommend = '/dj/recommend';
// 电台 - 分类
var _djCatelist = '/dj/catelist';
// 电台 - 分类推荐
var _djRecommendType = '/dj/recommend/type';
// 电台 - 订阅
var _djSub = '/dj/sub';
// 电台的订阅列表
var _djSublist = '/dj/sublist';
// 电台 - 详情
var _djDetail = '/dj/detail';
// 电台 - 节目
var _djProgram = '/dj/program';
//电台 - 付费精选
var _djPaygift = '/dj/paygift';
//退出登录
var _logout = '/logout';

//登录状态
var _loginStatus = '/login/status';
//获取帐号信息
var _userAccount = '/user/account';
//获取用户等级信息
var _userLevel = "/user/level";
//获取用户绑定信息
var _userBinding = "/user/binding";
//用户绑定手机
var _userReplacephone = "/user/replacephone";
//更新用户信息
var _userUpdate = "/user/update";
//更新头像
var _avatarUpload = "/avatar/upload";
//国家编码列表
var _countriesCode = "/countries/code/list";
//更新歌单描述
var _playlistDeseUpdate = "/playlist/desc/update";
//更新歌单名
var _playlistNameUpdate = "/playlist/name/update";
//更新歌单标签
var _playlistTagsUpdate = "/playlist/tags/update";
//歌单封面上传
var _playlistCoverUpdate = "/playlist/cover/update";
//调整歌单顺序
var _playlistOrderUpdate = "/playlist/order/update";
//调整歌曲顺序
var _songOrderUpdate = "/song/order/update";
//转发用户动态
var _eventForward = "/event/forward";
//删除用户动态
var _eventDel = "/event/del";
//分享歌曲、歌单、mv、电台、电台节目到动态
var _shareResource = "/share/resource";
//获取动态评论
var _commentEvent = "/comment/event";
//关注/取消关注用户
var _follow = "/follow";
//获取热门话题
var _hotTopic = "/hot/topic";
//云村热评
var _commentHotwall = "/comment/hotwall/list";
//心动模式/智能播放
var _playmodeIntelligence = "/playmode/intelligence/list";
//歌手热门50首歌曲
var _artistTopSong = "/artist/top/song";
//歌手全部歌曲
var _artistSongs = "/artist/songs";
//收藏的专栏
var _topicSublist = "/topic/sublist";
//收藏视频
var _videoSub = "/video/sub";
//收藏/取消收藏 MV
var _mvSub = "/mv/sub";
//收藏的 MV 列表
var _mvSublist = "/mv/sublist";
//精品歌单标签列表
var _playlistHighqualityTags = "/playlist/highquality/tags";
//相关歌单推荐
var _relatedPlaylist = "/related/playlist";
//默认搜索关键词
var _searchDefault = "/search/default";
//热搜列表(详细)
var _searchHotDetail = "/search/hot/detail";
//删除歌单
var _playlistDelete = "/playlist/delete";
//歌单收藏者
var _playlistSubscribers = "/playlist/subscribers";
//收藏视频到视频歌单
var _playlistTrackAdd = "/playlist/track/add";
//删除视频歌单里的视频
var _playlistTrackDelete = "/playlist/track/delete";
//最近播放的视频
var _playlistVideoRecent = "/playlist/video/recent";
//新歌速递
var _topSong = "/top/song";
//首页-发现
var _homepageBlockpage = "/homepage/block/page";
//首页-发现-圆形图标入口列表
var _homepageDragonball = "/homepage/dragon/ball";
//楼层评论
var _commentFloor = "/comment/floor";
//视频评论
var _commentVideo = "/comment/video";
//热门评论
var _commentHot = "/comment/hot";
//新版评论接口
var _commentNew = "/comment/new";
//抱一抱评论
var _hugComment = "/hug/comment";
//评论抱一抱列表
var _commentHuglist = "/comment/hug/list";
//发送/删除评论
var _comment = "/comment";
//资源点赞( MV,电台,视频)
var _resourceLike = "/resource/like";
//获取点赞过的视频
var _playlistMylike = "/playlist/mylike";
//专辑动态信息
var _albumDetailDynamic = "/album/detail/dynamic";
//收藏/取消收藏专辑
var _albumSub = "/album/sub";
//获取已收藏专辑列表
var _albumSublist = "/album/sublist";
//获取歌手详情
var _artistDetail = "/artist/detail";
//获取历史日推可用日期列表
var _historyRecommendSongs = "/history/recommend/songs";
//获取历史日推详情数据
var _historyRecommendSongsDetail = "/history/recommend/songs/detail";
//喜欢音乐列表
var _likelist = "/likelist";
//全部新碟
var _albumNew = "/album/new";
//最新专辑
var _albumNewest = "/album/newest";
//听歌打卡
var _scrobble = "/scrobble";
//全部 mv
var _mvAll = "/mv/all";
//网易出品mv
var _mvExclusiveRcmd = "/mv/exclusive/rcmd";
//独家放送列表
var _personalizedPrivatecontentList = "/personalized/privatecontent/list";
//获取 mv 点赞转发评论数数据
var _mvDetailinfo = "/mv/detail/info";
//获取视频标签列表
var _videoGrouplist = "/video/group/list";
//获取视频分类列表
var _videCategorylist = "/video/category/list";
//获取视频标签/分类下的视频
var _videoGroup = "/video/group";
//获取全部视频列表
var _videoTimelineAll = "/video/timeline/all";
//相关视频
var _relatedAllvideo = "/related/allvideo";
//视频详情
var _videoDetail = "/video/detail";
//获取视频点赞转发评论数数据
var _videoDetailinfo = "/video/detail/info";
//获取视频播放地址
var _videoUrl = "/video/url";
//云盘数据详情
var _userClouddetail = "/user/cloud/detail";
//云盘歌曲删除
var _userClouddel = "/user/cloud/del";
//电台banner
var _djBanner = "/dj/banner";
//电台个性推荐
var _djPersonalizeRecommend = "/dj/personalize/recommend";
//电台订阅者列表
var _djSubscriber = "/dj/subscriber";
//用户电台
var _userAudio = "/user/audio";
//热门电台
var _djHot = "/dj/hot";
//电台 - 节目榜
var _djProgramToplist = "/dj/program/toplist";
//电台 - 付费精品
var _djToplistPay = "/dj/toplist/pay";
//电台 - 24小时节目榜
var _djProgramtoplistHours = "/dj/program/toplist/hours";
//电台 - 主播新人榜
var _djToplistNewcomer = "/dj/toplist/newcomer";
//电台 - 最热主播榜
var _djToplistPopular = "/dj/toplist/popular";
//电台 - 新晋电台榜/热门电台榜
var _djToplist = "/dj/toplist";
//电台 - 类别热门电台
var _djRadioHot = "/dj/radio/hot";
//电台 - 非热门类型
var _djCategoryexcludehot = "/dj/category/excludehot";
//电台 - 推荐类型
var _djCategoryRecommend = "/dj/category/recommend";
//电台 - 今日优选
var _djTodayPerfered = "/dj/today/perfered";
//电台 - 节目详情
var _djProgramDetail = "/dj/program/detail";
//通知 - 私信
var _msgPrivate = "/msg/private";
//发送私信音乐
var _sendSong = "/send/song";
//最近联系人
var _msgRecentContact = "/msg/recentcontact";
//私信内容
var _msgPrivateHistory = "/msg/private/history";
//通知 - 评论
var _msgComments = "/msg/comments";
//通知 - @我
var _msgForwards = "/msg/forwards";
//通知 - 通知
var _msgNotices = "/msg/notices";
//设置
var _setting = "/setting";
//数字专辑-新碟上架
var _albumList = "/album/list";
//数字专辑&数字单曲-榜单
var _album_songsaleboard = "/album_songsaleboard";
//数字专辑-语种风格馆
var _albumListStyle = "/album/list/style";
//数字专辑详情
var _albumDetail = "/album/detail";
//我的数字专辑
var _digitalAlbumpurchased = "/digitalAlbum/purchased";
//购买数字专辑
var _digitalAlbumordering = "/digitalAlbum/ordering";
//音乐日历
var _calendar = "/calendar";
//云贝
var _yunbei = "/yunbei";
//云贝今日签到信息
var _yunbeiToday = "/yunbei/today";
//云贝签到
var _yunbeiSign = "/yunbei/sign";
//云贝账户信息
var _yunbeiInfo = "/yunbei/info";
//云贝所有任务
var _yunbeiTasks = "/yunbei/tasks";
//云贝todo任务
var _yunbeiTaskstodo = "/yunbei/tasks/todo";
//云贝完成任务
var _yunbeiTaskfinish = "/yunbei/task/finish";
//云贝收入
var _yunbeiTasksreceipt = "/yunbei/tasks/receipt";
//云贝支出
var _yunbeiTasksexpense = "/yunbei/tasks/expense";
//关注歌手新歌
var _artistNewsong = "/artist/new/song";
//关注歌手新MV
var _artistNewmv = "/artist/new/mv";
//batch批量请求接口
var _batch = "/batch";
...
//rgb(255,255,255),
var rgbObj = {
  rgbColor: function rgbColor(arr) {
    var thisValue = this;
    var colorArr = arr.map(function (item, index, arrs) {
      return thisValue.strArr(thisValue.strReg(item, 'rgb'));
    }, thisValue);
    return 'rgb(' + this.arrPlus(colorArr) + ')';
  },
  strArr: function strArr(str) {
    return str.split(',');
  },
  strReg: function strReg(str, del) {
  ...
  arrAnd: function arrAnd(arr) {
    return arr.reduce(function (prev, curr, idx, arr) {
      return Number(prev) + Number(curr);
    });
  },
  rgbBgk: function rgbBgk(number, length) {
...
/***/ 8:
/*!*****************************************************!*\
  !*** E:/bodhi/uni-app/uni-myMusic/common/player.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.audioPlay = audioPlay;exports.uniAudio = void 0;var uniAudio = uni.createInnerAudioContext();exports.uniAudio = uniAudio;
